...
OE_SUPERADMIN="Conn3ct2022!"
# Set to "True" to generate a random password, "False" to use the variable in OE_SUPERADMIN
GENERATE_RANDOM_PASSWORD="False"
OE_CONFIG="${OE_USER}-server"
# Set the website name
WEBSITE_NAME="hrm.unistusltd.co.ke"
# Set the default Odoo longpolling port (you still have to use -c /etc/odoo-server.conf for example to use this.)
LONGPOLLING_PORT="8072"
# Set to "True" to install certbot and have ssl enabled, "False" to use http
ENABLE_SSL="True"
# Provide Email to register ssl certificate
ADMIN_EMAIL="enquiry@unistus.co.ke"
##
...
if [ $INSTALL_NGINX = "True" ] && [ $ENABLE_SSL = "True" ] && [ $ADMIN_EMAIL != "enquiry@unistus.co.ke" ]  && [ $WEBSITE_NAME != "hrm.unistusltd.co.ke" ];then
