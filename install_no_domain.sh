...
apt -y install git build-essential libffi-dev libssl-dev python3 python3-dev python3-pip python3.8-venv python3-testresources wkhtmltopdf supervisor
...
su ${FRAPPE_USR} -c "cd /home/${FRAPPE_USR}/frappe-bench/; sudo bench setup production ${FRAPPE_USR} --yes"
